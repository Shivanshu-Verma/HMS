    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage prescriptions and inventory</p>
        </div>
        ...
        <Card className="border-0 shadow-md">
          <CardHeader className="border-b bg-muted/30">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/pharmacy/queue')}>
                  View All
            ...
            <div className="divide-y">
              {queue.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <p className="text-muted-foreground font-medium">No pending prescriptions</p>
                  <p className="text-sm text-muted-foreground mt-1">Prescriptions will appear here after doctor consultation</p>
                </div>
              )}
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <p className="text-sm text-amber-700">
                {lowStockCount} medicine{lowStockCount !== 1 ? 's' : ''} below reorder level. Please restock soon.
              </p>
              <Button variant="outline" size="sm" className="border-amber-300 hover:bg-amber-100" onClick={() => navigate('/pharmacy/inventory')}>
                View Inventory
              </Button>
            </div>
          </CardContent>
